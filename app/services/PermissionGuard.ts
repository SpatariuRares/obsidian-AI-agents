...
export class PermissionGuard {
     ...
     */
    static assertPermission(config: AgentConfig, operation: FileOperationType, path: string | null): void {
     ...
     */
    static hasPermission(config: AgentConfig, operation: FileOperationType, path: string | null): boolean {
     ...
     */
    private static getPatternsForOperation(config: AgentConfig, operation: FileOperationType): string[] {
        switch (operation) {
            case "read": return config.read;
            case "write": return config.write;
            case "create": return config.create;
            case "move": return config.move;
